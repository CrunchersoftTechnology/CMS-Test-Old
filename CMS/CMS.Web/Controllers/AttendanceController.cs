...
namespace CMS.Web.Controllers
{
    ...
    public class AttendanceController : BaseController
    {
        ...
        public ActionResult Index()
        {
            ...
            var attendanceList = roles == "Admin" ? _attendanceService.GetAttendance().ToList() : roles == "BranchAdmin" ? _attendanceService.GetAttendanceByBranchId(projection.BranchId).ToList() : null;
